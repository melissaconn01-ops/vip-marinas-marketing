# VIP Marinas Dashboard

**AI-Generated File — Refresh Regularly**

This file provides a quick portfolio-wide view of the VIP Marinas marketing projects. It is not the source of truth. Always refer to the CSV files for authoritative data.

Source files: `marina-index.csv`, `project-index.csv`, `project-tasks.csv`, `campaign-tracker.csv`, `tracking-issues.csv`, `event-tracker.csv`
        ...
        - - MER-STO-001 — Meridian Dry Storage Opening — Planning
          - - MER-EVT-001 — Meridian Bahamas Run — Planning
            ...
            - - ANC-WEB-001 — Anclote Website Service Updates — Needs Review
              ...
              | BH-EVT-001 | Bluff House | Bahamas Run Promotion | Planning | Create promotional email, flyer, registration process, and itinerary follow-up |
              ...
              |---|---|---|---|---|
              | LT-TRK-101 | Lake Travis | Form fill tracking not confirmed | Open | High |
              | LT-TRK-102 | Lake Travis | Phone call tracking not verified | Open | High |
              | LT-TRK-103 | Lake Travis | Kenect/text lead tracking gap | Open | Medium |
              ...
              | BH-EVT-001 | Bahamas Run Promotion | Bluff House | Planning | — | Confirm event dates and rates, draft email and flyer, create registration path |
              ...
              - event-tracker.csv has been created for event-specific tracking. MER-EVT-001 (Meridian Bahamas Run) is the first entry.
              - - MER-EVT-001 and BH-EVT-001 are cross-property related projects. Use Related Project ID fields to link them.
